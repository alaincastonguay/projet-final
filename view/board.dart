...
class Board {
  ...
  void draw() {
    ...
    if (memory.recalled) { // game over
      ...
      context.fillText("BRAVO !!!", boxSize,boxSize *1);
    }
  }
  ...
  void onMouseDown(MouseEvent e) {
    ...
    if (cell.twin == lastCellClicked) {
      ...
      if (memory.recalled) { // game over
        ...
        fireballs.play();
        new Timer(const Duration(milliseconds: 6000), () => memory.hide());
      }
    } else if (cell.twin.hidden) {
      new Timer(const Duration(milliseconds: 900), () => cell.hidden = true);
    }
